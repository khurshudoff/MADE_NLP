...
class Decoder(nn.Module):
    def __init__(self, output_dim, emb_dim, hid_dim, n_layers, dropout, linear_dropout=.7):
        super().__init__()
    ...
    def forward(self, input, hidden, encoder_output):
        ...
        prediction = self.linear1(torch.cat([attn_vect, output.squeeze(0)], dim=1))
        prediction = self.activation1(self.dropout1(prediction))
